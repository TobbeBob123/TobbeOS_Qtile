...
then
    ...
    yay -S alsa-utils qtile qtile-extras-git python-psutil htop kitty base-devel unzip zip bitwarden arandr zen-browser-bin vim discord gnome-keyring blueman flameshot beamerpresenter-git texlive-latexextra bat ispell aspell aspell-en aspell-nb hunspell rofi ttf-font-awesome-4 noto-fonts-emoji xdotool dracula-gtk-theme dracula-icons-git vifm network-manager-applet adobe-source-code-pro-fonts pacman-contrib doas xautolock lxsession eza lux-git trayer yad git jre-openjdk lightdm lightdm-gtk-greeter light-locker zip feh scrot dunst pavucontrol nm-connection-editor neovim libreoffice signal-desktop pipewire pipewire-pulse wireplumber xdg-desktop-portal-gnome picom pcmanfm emacs ripgrep lxappearance qt5ct dracula-cursors-git && \
