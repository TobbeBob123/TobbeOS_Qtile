...
* LightsOn
This daemon let your computer stay on when watching video in your webbrowser with help from a script. this will only work with Firefox.
The script i use with the daemon are make by unhammer. Much credit to unhammer. [[https://github.com/unhammer/][unhammer's gitlab]]
#+begin_src sh
