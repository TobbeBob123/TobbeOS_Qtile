...
* LightsOn
This daemon let your computer stay on when watching video in your webbrowser. The script will only work with Firefox.
This daemon are make by unhammer. Much credit to unhammer. [[https://github.com/unhammer/][unhammer's gitlab]]
#+begin_src sh
